...
label start1:
  ...
  # batas check
    ...
    MC "(huh? Who is it?)"
        menu: 
            "He sounds a little rough around the edges. I feel like I know him":+TSM
                    GTWU "If ya don’t wake up now, you're gonna be late."
                    GTWU "Geez, get an alarm or somethin’ "
                    MC "My bad."
            "Whoever it is, he’s friendly and chipper. He seems very familiar to me": +YM
...
label TSMafterloop1:   
   ...
   #Scene road with fade"
    ...
    "(Guess this is what happens when you actually eat breakfast instead of rushing off with an empty stomach)"
    "(Still, he goes way above what I expected him to do. I like having him do stuff for me and all, but I kinda feel bad)"
    (He even went as far as to wearing that maid outfit)"
    Menu:"
    "(Personally, I love it! He’s so cute!!)"
    "(I don’t know what he was thinking when he bought it but I like it!)"
    "(I think he’s going way too far)"
    "(I’m grateful that he’s doing housework but this seems too far, like it’s the plot of a self-indulgent piece of media.)"
    "
    ...
    *phone ringing sfx"
    ...
    "
    "Y’know, we eat together a lot but eating on the floor like this sure is a new feeling."
